...
import com.yngcy.ymagebackend.manager.FileManager;
import com.yngcy.ymagebackend.mapper.PictureMapper;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    public PictureVO uploadPicture(MultipartFile multipartFile, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        if (pictureId != null) {
            boolean exists = this.lambdaQuery()
                    ...
                    .exists();
            ThrowUtils.throwIf(!exists, ErrorCode.NOT_FOUND_ERROR, "picture id not found");
        }
        // 上传图片，得到信息
        // 按照用户ID划分目录
        ...
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR, "picture upload failed, database operation failed");
    ...
    public void validPicture(Picture picture) {
        ...
        ThrowUtils.throwIf(ObjUtil.isNull(id), ErrorCode.PARAMS_ERROR, "id is null");
